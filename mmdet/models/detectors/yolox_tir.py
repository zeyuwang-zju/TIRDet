...
class YOLOX_TIR(SingleStageDetector):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(YOLOX_TIR, self).__init__(backbone, neck, bbox_head, train_cfg,
    ...
    def forward_train(self,
        ...
        losses = super(YOLOX_TIR, self).forward_train(img, img_metas, gt_bboxes,
